...
CREATE TABLE `orders` (
  ...
  `totalPrices` double(20,2) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Records of orders
-- ----------------------------
INSERT INTO `orders` VALUES ('1', 'P201805160079', '已下单', 'tb39141_66', '王莽', '13697139145', '湖北省武汉市洪山区关山大道华夏学院', '2018-09-22 01:49:06', '66.00');
INSERT INTO `orders` VALUES ('2', 'P201805160080', '已发货', 'tb39141_78', '赵云', '13697139155', '广东省深圳市宝安区西乡街道海城路海城新村', '2018-09-22 01:52:09', '99.00');
...
CREATE TABLE `orders_product` (
  ...
  `totalPrices` double(15,2) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- ----------------------------
INSERT INTO `orders_product` VALUES ('1', '1', '1', '10', '3.00', '30.00');
INSERT INTO `orders_product` VALUES ('2', '1', '2', '8', '15.00', '12.00');
INSERT INTO `orders_product` VALUES ('3', '2', '2', '12', '3.00', '36.00');
...
-- Records of product
-- ----------------------------
INSERT INTO `product` VALUES ('1', '羽毛球123', '3.00', '205', '体育用品', 'sys', '无', '1');
INSERT INTO `product` VALUES ('2', '乒乓球', '1.50', '350', '体育用品', 'ymq-cvm-002', '无', '0');
INSERT INTO `product` VALUES ('3', '足球', '70.00', '535', '体育用品', 'ymq-cvm-003', '无', '0');
INSERT INTO `product` VALUES ('4', '蓝球', '100.00', '456', '体育用品', 'ymq-cvm-003', '无', '1');
INSERT INTO `product` VALUES ('5', '铅球', '150.00', '74', '体育用品', 'ymq-cvm-001', '无', '1');
INSERT INTO `product` VALUES ('6', '排球', '60.00', '80', '体育用品', 'ymq-cvm-001', '无', '0');
INSERT INTO `product` VALUES ('7', '网球', '80.00', '99', '体育用品', 'ymq-cvm-001', '无', '1');
INSERT INTO `product` VALUES ('8', '羽毛球(红色)', '50.00', '88', '体育用品', 'ymq-cvm-003', '无', '1');
INSERT INTO `product` VALUES ('9', '棒球', '55.00', '55', '普通的棒球', '123', '132', '0');
...
INSERT INTO `sys_logs` VALUES ('39', 'admin', '分页查询配置信息', 'com.jt.sys.service.impl.SysConfigServiceImpl.findPageObjects', '[null,1]', '38', '0:0:0:0:0:0:0:1', '2018-09-21 23:27:45');
INSERT INTO `sys_logs` VALUES ('40', 'admin', '分页查询配置信息', 'com.jt.sys.service.impl.SysConfigServiceImpl.findPageObjects', '[null,1]', '5', '0:0:0:0:0:0:0:1', '2018-09-21 23:27:56');
INSERT INTO `sys_logs` VALUES ('41', 'admin', '分页查询配置信息', 'com.jt.sys.service.impl.SysConfigServiceImpl.findPageObjects', '[null,1]', '68', '0:0:0:0:0:0:0:1', '2018-09-22 00:55:17');
INSERT INTO `sys_logs` VALUES ('42', 'admin', '分页查询配置信息', 'com.jt.sys.service.impl.SysConfigServiceImpl.findPageObjects', '[null,1]', '24', '0:0:0:0:0:0:0:1', '2018-09-22 07:33:32');
INSERT INTO `sys_logs` VALUES ('43', 'admin', '分页查询配置信息', 'com.jt.sys.service.impl.SysConfigServiceImpl.findPageObjects', '[null,1]', '6', '0:0:0:0:0:0:0:1', '2018-09-22 07:37:35');
INSERT INTO `sys_logs` VALUES ('44', 'admin', '分页查询配置信息', 'com.jt.sys.service.impl.SysConfigServiceImpl.findPageObjects', '[null,1]', '25', '0:0:0:0:0:0:0:1', '2018-09-22 10:27:29');
INSERT INTO `sys_logs` VALUES ('45', 'admin', '分页查询配置信息', 'com.jt.sys.service.impl.SysConfigServiceImpl.findPageObjects', '[null,1]', '21', '0:0:0:0:0:0:0:1', '2018-09-22 21:22:23');
INSERT INTO `sys_logs` VALUES ('46', 'admin', '分页查询配置信息', 'com.jt.sys.service.impl.SysConfigServiceImpl.findPageObjects', '[null,1]', '4', '0:0:0:0:0:0:0:1', '2018-09-22 21:22:43');
INSERT INTO `sys_logs` VALUES ('47', 'admin', '分页查询配置信息', 'com.jt.sys.service.impl.SysConfigServiceImpl.findPageObjects', '[null,1]', '5', '0:0:0:0:0:0:0:1', '2018-09-22 21:22:44');
INSERT INTO `sys_logs` VALUES ('48', 'admin', '分页查询配置信息', 'com.jt.sys.service.impl.SysConfigServiceImpl.findPageObjects', '[null,1]', '4', '0:0:0:0:0:0:0:1', '2018-09-22 21:22:45');
INSERT INTO `sys_logs` VALUES ('49', 'admin', '分页查询配置信息', 'com.jt.sys.service.impl.SysConfigServiceImpl.findPageObjects', '[null,1]', '4', '0:0:0:0:0:0:0:1', '2018-09-22 21:22:45');
